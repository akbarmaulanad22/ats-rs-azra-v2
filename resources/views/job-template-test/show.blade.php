<x-layouts.app title="Konfigurasi Tes - {{ $templateLowongan->judul_posisi }} - ATS RS Azra">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4"
         x-data="testConfig(
            {{ $jobTemplateTest ? $jobTemplateTest->questions->pluck('id')->toJson() : '[]' }},
        ...
        <div>
            <div class="bg-white/80 border border-gray-200 rounded-md">
                <form method="POST" action="{{ route('template-lowongan.tes.save', $templateLowongan) }}" @submit="prepareSubmit()">
                    @csrf
                    ...
                    <div class="px-4 pt-4 pb-5 space-y-3">
                        ...
                        <div>
                            ...
                            <input type="number" name="batas_waktu_menit" min="5" max="480"
                                value="{{ old('batas_waktu_menit', $jobTemplateTest?->batas_waktu_menit ?? 60) }}" required
                        ...
                        @if ($jobTemplateTest)
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-700">{{ $jobTemplateTest->questions->count() }} soal &mdash; {{ $jobTemplateTest->batas_waktu_menit }} menit</p>
                            </div>
                        @endif
                    </div>
