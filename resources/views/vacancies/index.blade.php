                        ...
                        <tr class="odd:bg-white even:bg-primary/5 hover:bg-primary/10 transition-colors ease-out duration-100">
                            ...
                            <td class="px-3 py-1.5">
                                <div class="flex items-center justify-end gap-0.5">
                                    ...
                                    @can('callback', $vacancy)
                                    <a
                                        href="{{ route('callback.index', $vacancy) }}"
                                        class="p-1.5 rounded text-purple-400/60 hover:text-purple-500 hover:bg-purple-50 transition-colors ease-out duration-150"
                                        title="Panggil kembali kandidat gagal"
                                        aria-label="Panggil kembali {{ $vacancy->judul_posisi }}"
                                    >
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
