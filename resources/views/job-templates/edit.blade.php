<x-layouts.app title="Edit Template Lowongan - ATS RS Azra">
    ...
    <div class="mb-4">
        ...
        <h1 class="text-xl font-semibold text-gray-900">Edit Template Lowongan</h1>
        <p class="text-xs text-gray-500 mt-0.5">{{ $templateLowongan->judul_posisi }}</p>
    </div>

    <div class="bg-white/80 border border-gray-200 rounded-md">
        <form method="POST" action="{{ route('template-lowongan.update', $templateLowongan) }}">
            @csrf
            @method('PUT')
