<x-layouts.app title="Buat Template Alur Rekrutmen - ATS RS Azra">
    ...
    <div class="mb-4">
        ...
        <h1 class="text-xl font-semibold text-gray-900">Buat Template Alur Rekrutmen</h1>
    </div>
    ...
    <div
        ...
        x-data="workflowBuilder(
            {{ $stages->toJson() }},
            {{ json_encode(old('stage_ids', [])) }}
        )"
    >
        <form method="POST" action="{{ route('alur-rekrutmen.store') }}" @submit="prepareSubmit">
            @csrf
